...
package enum ClaudeRepoContentFilter {
    ...
    package static let excludedComponents: Set<String> = [
        ".build",
        ".git",
        ".gradle",
        ".idea",
    ...
    package static let excludedExtensions: Set<String> = [
    ...
    package static let excludedFilenames: Set<String> = [
        "Package.resolved",
        "package-lock.json",
        "pnpm-lock.yaml",
        "yarn.lock",
    ...
    package static func isGeneratedOrVendored(_ relativePath: String) -> Bool {
    ...
    package static func isLogLike(_ relativePath: String) -> Bool {
    ...
    /// is not.
    package static let secretComponents: Set<String> = [
        ".aws",
        ".gcloud",
        ".gnupg",
        ".ssh",
    ...
    package static let secretNameWords: Set<String> = [
    ...
    package static let secretConfigExtensions: Set<String> = [
    ...
    package static let nonSecretEnvSuffixes: Set<String> = [
    ...
    package static func isSecretLike(_ relativePath: String) -> Bool {
        let components = relativePath.split(separator: "/").map(String.init)
    ...
    package static func basenameWords(_ filename: String) -> Set<String> {
    ...
    package static func looksBinary(_ data: Data, headBytes: Int = 8_000) -> Bool {
    ...
    package static let minimumBasenameMatchLength = 8
    ...
    package static func basenameMatchForms(_ path: String) -> [String] {
    ...
    package static func transcriptMatchedPaths(
        trackedPaths: [String],
