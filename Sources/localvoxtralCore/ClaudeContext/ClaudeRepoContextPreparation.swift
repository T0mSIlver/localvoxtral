...
package struct ClaudeRepoContextPreparation: Sendable, Equatable {
    ...
    package static let empty = ClaudeRepoContextPreparation(grounding: .empty, excerpt: "")
    ...
    package nonisolated static func renderDemand(snapshot: ClaudeRepoSnapshot) async -> Int {
    ...
    package struct GroundingSources: Sendable, Equatable {
    ...
    package nonisolated static func groundingSources(snapshot: ClaudeRepoSnapshot) -> GroundingSources {
    ...
    package nonisolated static func terms(from sources: GroundingSources) -> [String] {
...
package enum LocalWorkspacePathDisplay {
    package static func relativePath(of path: String, under workspace: LocalWorkspacePath) -> String? {
