...
package protocol ClaudeRemoteHerdrForwardProcess: ClaudeRemoteForwardProcess, AnyObject {
...
package protocol ClaudeRemoteHerdrForwardSpawning: Sendable {
...
package struct ClaudeRemoteHerdrForwardWorkspace: Sendable, Equatable {
    package var directoryPath: String
    package var socketPath: String

    package init(directoryPath: String, socketPath: String) {
        self.directoryPath = directoryPath
        self.socketPath = socketPath
    }
}

package protocol ClaudeRemoteHerdrWorkspaceProviding: Sendable {
...
package final class ClaudeRemoteHerdrForwardHandle: Sendable, Equatable {
    ...
    /// while owning one.
    package static func == (lhs: ClaudeRemoteHerdrForwardHandle, rhs: ClaudeRemoteHerdrForwardHandle) -> Bool {
        lhs === rhs
    }
    ...
    package var isRunning: Bool { isProcessRunning() }
...
@MainActor
package protocol ClaudeRemoteHerdrForwarding: AnyObject {
