...
extension ClaudeSessionJoinResolver {
    ...
    package func resolveViaCmux(target: TerminalScreenTarget) async -> ClaudeSessionJoin? {
    ...
    package func cmuxSurfaceVisibleText(for join: ClaudeSessionJoin) async -> String? {
