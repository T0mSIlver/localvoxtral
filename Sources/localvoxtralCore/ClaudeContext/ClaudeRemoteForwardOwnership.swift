...
public final class ClaudeRemoteForwardProbeWitness: Sendable {
    ...
    package static let maximumArmed = 8
    ...
    package var armedCount: Int { state.withLock { $0.entries.count } }
}
...
package enum ClaudeRemoteForwardOwnershipCheck {
    ...
    package static let defaultTimeout: TimeInterval = 10
    ...
    package static func script(nonce: String, remoteForwardPort: UInt16) -> String {
        """
        exec >/dev/null 2>&1
    ...
    package static func argv(sshHostAlias: String) -> [String] {
        [
            "ssh",
            "-o", "BatchMode=yes",
