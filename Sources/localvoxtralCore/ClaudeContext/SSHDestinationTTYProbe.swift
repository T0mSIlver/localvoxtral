...
package enum HerdrInvocation: Sendable, Equatable {
...
package struct SSHSurfaceConnection: Sendable, Equatable {
    ...
    package var hasCompetingHerdrClient: Bool
    ...
    package var herdr: HerdrInvocation
    ...
    package var surfaceProcessStartTime: Date?
...
package struct SSHSiblingSurvey: Sendable, Equatable {
    ...
    package var leavesMultiplexingPossible: Bool { socketless > 0 || unreadable > 0 }
}
...
package enum SSHDestinationTTYProbeResult: Sendable, Equatable {
...
package struct SSHClientProcess: Sendable, Equatable {
    ...
    package var ttyDevice: dev_t?
    package var processGroupID: Int32
    /// The foreground process group of its controlling terminal.
    package var terminalForegroundGroupID: Int32
    ...
    package var effectiveUserID: uid_t
    ...
    package var isForegroundOfItsTerminal: Bool {
...
package enum SSHDestinationTTYProbe {
    ...
    package static let canonicalSSHExecutablePaths = [
        "/usr/bin/ssh",
    ...
    package static func isTrustedSSHExecutable(
        _ path: String,
    ...
    package static func installationRoot(ofCanonicalPath canonical: String) -> String? {
    ...
    package static func canonicalPath(of path: String) -> String? {
        guard let resolved = realpath(path, nil) else { return nil }
        defer { free(resolved) }
        return String(cString: resolved)
    }

    package static func connection(onTTYDevicePath path: String) -> SSHDestinationTTYProbeResult {
        connection(
    ...
    package static func surveySiblings(
        destination: String,
        surfacePID: Int32,
        surfaceUserID: uid_t,
        connections: [SSHClientProcess],
    ...
    /// never a join.
    package static func mentionsHerdr(_ argv: [String]) -> Bool {
        argv.contains { $0.contains("herdr") }
    }

    // MARK: - argv parsing

    package struct ParsedInvocation: Sendable, Equatable {
        package var destination: String
        package var herdr: HerdrInvocation
    ...
    package static func parse(arguments argv: [String]) -> ParsedInvocation? {
    ...
    package static func classifyHerdrCommand(_ remoteCommand: [String]) -> HerdrInvocation {
    ...
    package static func commandNamesHerdr(_ remoteCommand: [String]) -> Bool {
    ...
    package enum OptionConsumption: Sendable, Equatable {
    ...
    package static func consumption(ofOptionToken token: String) -> OptionConsumption {
    ...
    package static func normalizedDestination(_ operand: String) -> String? {
    ...
    package static let liveSSHProcesses: @Sendable () -> [SSHClientProcess]? = {
    ...
    package static func sshProcesses(
    ...
    package static func parseProcessArguments(_ buffer: [UInt8]) -> [String]? {
...
package enum TTYProcessTable {
    package struct Entry: Sendable, Equatable {
        package var pid: Int32
        package var parentProcessID: Int32
    ...
    package static let liveDeviceID: @Sendable (String) -> dev_t? = { path in
    ...
    package static func entries(onDevice device: dev_t) -> [Entry]? {
    ...
    package static func startTime(of process: kinfo_proc) -> Date? {
