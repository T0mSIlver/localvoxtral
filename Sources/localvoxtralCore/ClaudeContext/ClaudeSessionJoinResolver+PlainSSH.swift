...
extension ClaudeSessionJoinResolver {
    ...
    package func resolveViaPlainSSHConnection(
    ...
    package static func isPlainSSHShellSession(_ snapshot: ClaudeSessionSnapshot) -> Bool {
    ...
    package static let multiplexerLabels: [ClaudeRemoteEnvironmentField] = [
