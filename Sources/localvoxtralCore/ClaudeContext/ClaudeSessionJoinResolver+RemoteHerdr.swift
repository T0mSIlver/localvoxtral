...
extension ClaudeSessionJoinResolver {
    ...
    package func resolveViaRemoteHerdr(
    ...
    package static func confirmRemoteHerdrPane(
        herdrPanes: HerdrPaneQuerying,
        socketPath: String,
        hostID: String,
        candidates: [ClaudeSessionSnapshot],
    ...
    package static func scopedRemoteSessionID(
        claimed: String,
        hostID: String,
    ...
    package static func remoteAgentIsForeground(
