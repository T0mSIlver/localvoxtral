...
package final class ClaudeRemoteForwardLiveProcess: ClaudeRemoteForwardProcess, @unchecked Sendable {
    ...
    package var processIdentifier: pid_t { process.processIdentifier }
