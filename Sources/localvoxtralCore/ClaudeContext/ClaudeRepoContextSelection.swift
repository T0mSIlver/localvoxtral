...
/// bytes out.
package enum ClaudeRepoContextSelection {
    ...
    package enum Section: String, CaseIterable, Hashable {
        case activeFiles
        case diff
        case worktree
        case snippets
    ...
    package static let sectionFloorCharacters = 150
    ...
    package static func renderableCharacterCount(snapshot: ClaudeRepoSnapshot) -> Int {
    ...
    package static func groundingText(snapshot: ClaudeRepoSnapshot) -> String {
        var parts: [String] = []
