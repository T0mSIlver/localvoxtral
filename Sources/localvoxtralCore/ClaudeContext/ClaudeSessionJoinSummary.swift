...
package struct ClaudeSessionJoinSummary: Codable, Equatable, Sendable {
    ...
    package static func armName(_ mechanism: ClaudeSessionJoinMechanism) -> String {
        switch mechanism {
