...
package struct LiveClaudeRemoteSSHConfigFileSystem: ClaudeRemoteSSHConfigFileSystem {
...
package struct LiveClaudeLocalHerdrConfigFileSystem: ClaudeLocalHerdrConfigFileSystem {
    ...
    package func readState() throws -> ClaudeLocalHerdrConfigState {
    ...
    package func atomicWriteConfig(_ data: Data, permissions: UInt16, expectedConfigPresent: Bool) throws {
...
package struct LiveClaudeShellRCFileSystem: ClaudeShellRCFileSystem {
    ...
    package func readState() throws -> ClaudeShellRCState {
    ...
    package static func anyComponentIsSymlink(under home: URL, relativePath: String) -> Bool {
        var current = home
...
package enum ClaudeLoginShellReader {
    ...
    package static func loginShellPath(
    ...
    package static func liveDSCL() -> String? {
        runCapturingOutput(
    ...
    package static func runCapturingOutput(
        executableURL: URL,
        arguments: [String],
...
extension ClaudeRemoteEnrollmentService {
    package static func live() -> ClaudeRemoteEnrollmentService {
