...
package final class PipeLineReader: @unchecked Sendable {
    ...
    package init(fileHandle: FileHandle, onLine: @Sendable @escaping (String) -> Void) {
    ...
    package func waitUntilFinished() {
