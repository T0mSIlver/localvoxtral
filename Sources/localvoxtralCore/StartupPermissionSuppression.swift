...
package enum StartupPermissionSuppression {
    /// Set to `"1"` by the packaged-app launch smoke (`ci.yml`, `release.yml`).
    package static let environmentKey = "LOCALVOXTRAL_SUPPRESS_STARTUP_PERMISSION_PROMPTS"
    ...
    package static func loginKeychainIsDisabled(
        environment: [String: String] = ProcessInfo.processInfo.environment
    ) -> Bool {
