...
public struct VibeHooksBlockEditor: Sendable, Equatable {
    ...
    func declaresOurHookOutsideBlock(_ existing: String) -> Bool {
    ...
    func keyFollowsBlock(_ existing: String) -> Bool {
    ...
    func hasUnclosedOrMarkedMultilineString(_ existing: String) -> Bool {
        var openBasic = false
    ...
    func definesHooksStatically(_ existing: String) -> Bool {
